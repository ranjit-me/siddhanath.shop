...
import img1 from '../PRODUCTS/BRANDS/BioSeed/assets/Screenshot 2025-07-09 175400.png';
import img2 from '../PRODUCTS/BRANDS/BioSeed/assets/Screenshot 2025-07-09 175455.png';
import img3 from '../PRODUCTS/BRANDS/BioSeed/assets/Screenshot 2025-07-09 175633.png';

const bioSeedProducts = [
  { id: 1, image: img1, name: 'TX-369', soldOut: false },
  { id: 2, image: img2, name: 'Bio 9792', soldOut: false },
  { id: 3, image: img3, name: 'Bio 208', soldOut: false },
];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {bioSeedProducts.map((product) => (
          ...
          >
            ...
            <p className="text-sm text-gray-500 mb-4">BioSeed</p>
