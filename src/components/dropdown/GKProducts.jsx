...
import P1_GK2002 from '../PRODUCTS/BRANDS/GANGAKAVERI/assets/P1_GK2002.png';
import P2_GK3063KING from '../PRODUCTS/BRANDS/GANGAKAVERI/assets/P2_GK3063KING.jpg';
import P3_GK3059KING from '../PRODUCTS/BRANDS/GANGAKAVERI/assets/P3_GK3059KING.png';
    ...
    <div className="p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {products.map((product) => (
        ...
        >
          ...
          <p className="text-sm text-gray-500 mb-4">GK Seeds</p>
