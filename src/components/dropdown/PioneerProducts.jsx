...
import P1_PIO3302 from '../PRODUCTS/BRANDS/Pioneer/assets/P1_PIO3302.png';
import P2_PIO3502 from '../PRODUCTS/BRANDS/Pioneer/assets/P2_PIO3502.png';
import P3_PIO86M38 from '../PRODUCTS/BRANDS/Pioneer/assets/P3_PIO86M38.png';
import P4_PIO86M38 from '../PRODUCTS/BRANDS/Pioneer/assets/P4_PIO86M38.png';
import P5_PIO3524 from '../PRODUCTS/BRANDS/Pioneer/assets/P5_PIO3524.png';

const products = [
  { id: 1, image: P1_PIO3302, name: 'PIO3302 Maize Seeds', link: '/cortiva', soldOut: false, discount: '10% OFF', price: 1000, original: 1100, savings: 100, size: '4 Kg' },
  { id: 2, image: P2_PIO3502, name: 'PIO3502 Maize Seeds', link: '/cortiva', soldOut: false, discount: '12% OFF', price: 1050, original: 1200, savings: 150, size: '4 Kg' },
  { id: 3, image: P3_PIO86M38, name: 'PIO86M94 Maize Seeds', link: '/cortiva', soldOut: false, discount: '15% OFF', price: 950, original: 1120, savings: 170, size: '4 Kg' },
  { id: 4, image: P4_PIO86M38, name: 'PIO86M38 Maize Seeds', link: '/cortiva', soldOut: false, discount: '8% OFF', price: 980, original: 1060, savings: 80, size: '4 Kg' },
  { id: 5, image: P5_PIO3524, name: 'PIO3524 Maize Seeds', link: '/cortiva', soldOut: false, discount: '20% OFF', price: 1200, original: 1500, savings: 300, size: '4 Kg' },
];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {products.map(product => (
          ...
          >
            ...
            <p className="text-sm text-gray-500 mb-4">Pioneer</p>
