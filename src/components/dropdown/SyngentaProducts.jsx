...
import img1 from '../PRODUCTS/BRANDS/SYNGENTA/assets/Cruiser 350 FS.png';
import img2 from '../PRODUCTS/BRANDS/SYNGENTA/assets/Isabion.png';
import img3 from '../PRODUCTS/BRANDS/SYNGENTA/assets/KavachFlo.png';
import img4 from '../PRODUCTS/BRANDS/SYNGENTA/assets/Score.png';

const syngentaProducts = [
  { id: 1, image: img1, name: 'Cruiser 350 FS', link: '/syngenta', soldOut: false, discount: '10% OFF', price: 1000, original: 1100, savings: 100, size: '1 L' },
  { id: 2, image: img2, name: 'Isabion', link: '/syngenta', soldOut: false, discount: '12% OFF', price: 1050, original: 1200, savings: 150, size: '1 L' },
  { id: 3, image: img3, name: 'KavachFlo', link: '/syngenta', soldOut: false, discount: '15% OFF', price: 950, original: 1120, savings: 170, size: '1 L' },
  { id: 4, image: img4, name: 'Score', link: '/syngenta', soldOut: false, discount: '8% OFF', price: 980, original: 1060, savings: 80, size: '1 L' },
];


function SyngentaProducts() {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {syngentaProducts.map((product) => (
          ...
          >
            ...
            <p className="text-sm text-gray-500 mb-4 font-semibold">Brand: Syngenta</p>
...
export default SyngentaProducts;
