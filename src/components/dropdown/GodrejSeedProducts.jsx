...
import img1 from '../PRODUCTS/BRANDS/GodrejSeed/assets/GA-118.png';

const godrejSeedProducts = [
  { id: 1, image: img1, name: 'GA-118', discount: '10% OFF', price: 900, original: 1000, savings: 100, size: '1 L', link: '/godrejseed', soldOut: false },
];
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {godrejSeedProducts.map((product) => (
          <div
            key={product.id}
          ...
          <p className="text-sm text-gray-500 mb-4">GodrejSeed</p>
