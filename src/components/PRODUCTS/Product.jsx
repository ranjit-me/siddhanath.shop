...
import JaiKisanRoute from './BRANDS/JaiKisan/JaiKisanProducts';
...
function Product() {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl font-bold text-blue-700 mt-8 mb-6 border-b-2 border-blue-300 pb-2">Pesticide</h1>
      ...
      <h1 className="text-4xl font-bold text-purple-700 mt-8 mb-6 border-b-2 border-purple-300 pb-2">Fertilizer</h1>

      <h2 className="text-2xl font-semibold text-gray-700 mt-4 mb-2">Jai Kisan</h2>
      <JaiKisanRoute />
    </motion.div>
  );
}
