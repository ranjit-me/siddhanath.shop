...
import img1 from './assets/Tracer.png';
import img2 from './assets/Goal.png';
import img3 from './assets/Deleget.png';
import img4 from './assets/Curzate.png';

const dowProducts = [
  { id: 1, image: img1, name: 'Tracer', link: '/dow', soldOut: false },
  { id: 2, image: img2, name: 'Goal', link: '/dow', soldOut: false },
  { id: 3, image: img3, name: 'Deleget', link: '/dow', soldOut: false },
  { id: 4, image: img4, name: 'Curzate', link: '/dow', soldOut: false },
];
    ...
    <div className="p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {dowProducts.map((product) => (
        <div key={product.id} className="relative border rounded-2xl shadow hover:shadow-lg transition p-4 flex flex-col">
          ...
          <p className="text-sm text-gray-500 mb-4">Dow</p>
